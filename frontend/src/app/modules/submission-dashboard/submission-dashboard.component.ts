...
import { SubmissionService, SubmissionSummaryResponse, SubmissionDto } from '../../shared/services/api.services';
...
@Component({
  ...
  template: `
    <div class="page-header">
      <div>
        ...
        <p>Module 2 — Data Submission (Institution → Bureau)</p>
      </div>
    </div>
  ...
  styles: [`
    ...
    .month-cell { text-align:center; padding:8px 12px; border-radius:8px;
                  background:#F5F5F5; min-width:60px; }
