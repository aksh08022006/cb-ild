...
@Component({
  ...
  styles: [`
    ...
    .field-item { display:flex; align-items:flex-start; gap:8px; padding:8px; border-radius:6px;
    ...
    .warning-item { display:flex; align-items:flex-start; gap:8px; padding:8px 0;
